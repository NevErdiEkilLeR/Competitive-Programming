...
- [2013/텀 프로젝트](./ACM-ICPC/텀_프로젝트.java) (DFS & 사이클)
...
- [색종이 붙이기](./Samsung/색종이_붙이기.java) (브루트포스)
...
- [2018 1차/뉴스 클러스터링](./Kakao/뉴스_클러스터링.java) (문자열 & 해쉬 & 정규표현식)
- [2019/2번](./Kakao/2.cpp)
...
- [2019/1. 공정한 심사](./Osam/1_공정한_심사.cpp)
- [2019/2. 행운권 추첨](./Osam/2_행운권_추첨.cpp)
- [2019/3. UI EVENT](./Osam/3_UI_EVENT.cpp)
- [2019/4. 흔한 제목 찾기](./Osam/4_흔한_제목_찾기.cpp)
- [2020/1](./Osam/2020_1.java)
- [2020/2](./Osam/2020_2.java) (투 포인터)
- [2020/3](./Osam/2020_3.java) (투 포인터)
- [2020/4](./Osam/2020_4.java) (LCA & DP)
...
- [기본합2](./기본유형/기본합2.java)
- [괄호](./기본유형/괄호.java) (조합)
- [Acka](./기본유형/Acka.java) (브루트포스)
- [N으로 표현](./프로그래머스/N으로_표현.java) (브루트포스)

## 트리

- [~~히스토그램에서 가장 큰 직사각형~~](./기본유형/히스토그램.cpp) (분할 정복 & SG 트리)
- [구간 합 구하기](./기본유형/구간_합_구하기.java) (SG 트리)
...
- [숨바꼭질 4](./기본유형/숨바꼭질_4.java) (BFS)
- [벽 부수고 이동하기 2](./기본유형/벽_부수고_이동하기_2.java) (BFS)
- [게](./기본유형/게임.java) (DFS & DP)
